...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://greglski.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("grzegorzleczkowski");
        driverTrello.findElement(By.id("password")).sendKeys("trudne0)");
