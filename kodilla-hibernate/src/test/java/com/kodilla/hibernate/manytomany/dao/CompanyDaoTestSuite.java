...
public class CompanyDaoTestSuite {
    ...
    public void testNamedQuerries() {
        ...
        //Then
        Assert.assertEquals(1, companiesWithName.size());
        Assert.assertEquals("Data Maesters", companiesWithName.get(0).getName());
        Assert.assertEquals(1, employeesWithLastname.size());
        Assert.assertEquals("John", employeesWithLastname.get(0).getFirstname());
